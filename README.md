# DH Fullstack - Desafio Javascript I
 ...
 ```javascript
  ...
  function buscarAluno(nome:string):object
  ...
  function matricularAluno(aluno:object, curso:string):void
  /* Essa funcionalidade irá permitir, cadastrar um aluno em um curso. 
  Essa função só poderá ser executada em um aluno já devidamente cadastrado no sistema, e deverá armazenar a data atual no momento da matricula
  Lembre-se de exibir o feedback para o usuário. */

  function aplicarFalta(aluno:object):void
  /*
  ...
  */
  ...
  function aplicarNota(aluno:object):void
  /*
  ...
  */
   ...
   function aprovarAluno(aluno:object):object
   /* 
